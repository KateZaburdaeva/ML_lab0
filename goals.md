...
Я пока только начинаю свой путь в разработке программного обеспечения. Раньше писала небольшие программы на Python в рамках учёбы, но с настоящими проектами и системами контроля версий почти не работала. Мой профиль на GitHub можно посмотреть по [этой ссылке](https://github.com/твой-логин).
